...
def main():
    ...
    with mlflow.start_run() as run:
        try:
            clf = load_model("C:\\Users\\PC\\Documents\\MLOps-IMDB-Sentiment-Analysis\\models\\model.pkl")
            test_data = load_data("C:\\Users\\PC\\Documents\\MLOps-IMDB-Sentiment-Analysis\\data\\processed\\test_bow.csv")
